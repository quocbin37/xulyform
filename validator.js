...
Validator.ismatkhau =  function(selector){
     return {
        ...
        test: function (value){
            ...
            return regex.test(value) ? undefined : 'Mật khẩu phải trên 8 ký tự, bao gồm 1 chữ thường, 1 in hoa, 1 chữ số và 1 ký tự đặc biệt';
...
Validator.isConfirmed =function (selector,getConfirmedValue,message){
    return {
        selector:selector,
        test: function (value){
            return value === getConfirmedValue() ? undefined : message || 'Nhap Vao Chua Chinh Xac'
